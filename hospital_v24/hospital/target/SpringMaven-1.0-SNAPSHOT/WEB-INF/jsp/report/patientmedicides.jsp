                        ...
                        <tbody>
                            <c:forEach items="${map.onlineAppointments}" var="report">
                                <tr>
                                    ...
                                    <td style="color: #0000ff">${report.medicine1}</td>
                                    <td style="color: #0000ff">${report.medicine2}</td>
                                    <td style="color: #0000ff">${report.medicine3}</td>
                                    <td style="color: #0000ff">${report.medicine4}</td>
                                    <td style="color: #0000ff">${report.medicine5}</td>
                                    <!--                                    <td> 
