        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-warning mb-0">Staff Notice Page</h3>
                    ...
                    <c:forEach items="${map.notice}" var="n">
                        <div class="col-lg-4 mb-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">${n.date}</h5>
                                    <p class="card-text">${n.notice_number}</p>
                                    <a href="" class="btn btn-outline-success btn-sm">${n.notice_title}</a>
                                    <a href="" class="btn btn-outline-success btn-sm">${n.notice_discription}</a>
                                    <a href="" class="btn btn-outline-success btn-sm">${n.notice_privilege}</a>
