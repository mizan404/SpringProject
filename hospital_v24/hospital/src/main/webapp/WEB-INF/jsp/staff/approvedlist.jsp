    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bgm" >
        <div class="container-fluid d-flex flex-column p-0">
            ...
            <ul
                ...
                <li class="nav-item" role="presentation"><a class="nav-link" href="/staff/approvelist"><i class="fas fa-user" style="color: rgba(197,1,1,0.74);"></i><span style="color: #0e20c2;"><strong>Approved Appointment List</strong><br></span></a></li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container my-4">
                    <p class="font-weight-bold">Approved Appointment Page</p>
                            ...
                            <div class="table-responsive table-bordered table table-hover table-bordered results"
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${map.approveLists}" var="approveList">
                                            <tr>
                                                <td>${approveList.id}</td>
                                                <td>${approveList.appointmentDate}</td>
                                                <td>${approveList.patient_nid}</td>
                                                <td>${approveList.patient_problem}</td>
                                                <td>${approveList.contact_number}</td>
                                                ...
                                                <td class="text-center">
                                                    <a href="/approveEdit/${approveList.id}" >
                                                        <button class="btn btn-info mb-1"><i class="fa fa-edit" aria-hidden="true"></i>
                                                        </button>
                                                    </a>  
                                                    <a href="approvedelete/${approveList.id}" >
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <form action="" method="POST">
                                                                                    <div class="form-group">
                                                                                        <div class="input-group">
                                                                                            <div class="input-group-prepend">
                                                                                                <span class="text-primary input-group-text">NID</span>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="input-group">
                                                                                            <div class="input-group-prepend">
                                                                                                <span class="text-primary input-group-text"></span>
                                                                                            </div><input class="form-control" type="text" required="" id="patient_problem"/>
