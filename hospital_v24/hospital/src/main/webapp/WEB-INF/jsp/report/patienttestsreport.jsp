        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-warning mb-0">Patient Medicine Report Page</h3>
                        ...
                        <tbody>
                            <c:forEach items="${map.onlineAppointments}" var="report">
                                <tr>
                                    ...
                                    <td style="color: #0000ff">${report.test1}</td>
                                    <td style="color: #0000ff">${report.test_report1}</td>
                                    <td style="color: #0000ff">${report.test2}</td>
                                    <td style="color: #0000ff">${report.test_report2}</td>
                                    <td style="color: #0000ff">${report.test3}</td>
                                    <td style="color: #0000ff">${report.test_report3}</td>
                                    <td style="color: #0000ff">${report.test4}</td>
                                    <td style="color: #0000ff">${report.test_report4}</td>
                                    <td style="color: #0000ff">${report.test5}</td>
                                    <td style="color: #0000ff">${report.test_report5}</td>
