        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-warning mb-0">Patient Symptoms Report Page</h3>
                        ...
                        <tbody>
                            <c:forEach items="${map.onlineAppointments}" var="report">
                                <tr>
                                    ...
                                    <td style="color: #0000ff">${report.symptom1}</td>
                                    <td style="color: #0000ff">${report.symptom2}</td>
                                    <td style="color: #0000ff">${report.symptom3}</td>
                                    <td style="color: #0000ff">${report.symptom4}</td>
                                    <td style="color: #0000ff">${report.symptom5}</td>
                                    <!--                                    <td> 
