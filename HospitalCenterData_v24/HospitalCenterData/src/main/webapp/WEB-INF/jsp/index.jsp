    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-md fixed-top shadow-lg" style="background-color: #ffffff; margin-left: 0px;margin-bottom: 0px;">
            <div class="container">
                ...
                <h4>Patient Center Database</h4>
                <div
                    class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav text-primary ml-auto">
                        <li class="nav-item text-primary border rounded" role="presentation" data-bs-hover-animate="pulse" style="color: rgb(0,0,0);background-color: #32a852;margin-right: 5px;"><a class="nav-link active text-uppercase" href="/info/login" style="color: rgb(255,255,255);font-size: 20px;"><strong>Login</strong></a></li>
            ...
            <footer>
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <h3>Developed By Mohammad Mizanur Rahman</h3>
                        <br>
