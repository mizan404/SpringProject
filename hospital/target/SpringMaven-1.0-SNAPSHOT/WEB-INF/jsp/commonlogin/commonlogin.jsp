...
<div class="container text-center" style="margin-top: 50px;margin-bottom: 150px;">
    <div class="row">
        <div class="col text-center"><a href="login"><button class="btn btn-primary btn-lg text-uppercase" data-bs-hover-animate="pulse" type="button" style="height: 60px;width: 140px;font-size: 25px;"><strong>Admin</strong><br></button></a></div>
