...
<html>
    ...
    <body>
        <nav class="navbar navbar-light navbar-expand-md fixed-top shadow-lg" style="background-color: #ffffff;margin-left: 0px;margin-bottom: 0px;">
            <div class="container"><a class="navbar-brand" href="#"><img src="/resources/vendor/css/assets/img/loader.gif" style="width: 60px;"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav text-primary ml-auto">
                        <li class="nav-item text-primary border rounded" role="presentation" data-bs-hover-animate="pulse" style="color: rgb(0,0,0);background-color: #32a852;margin-right: 5px;"><a class="nav-link active text-uppercase" href="/commonlogin" style="color: rgb(255,255,255);font-size: 20px;"><strong>Login</strong></a></li>
        ...
        <div class="container ">
            <div class="row">
                <div class="center-box">
                    ...
                    <button type="button" class="btn btn-link  btn-block"> <a href="faculty-login.html">Faculty Login</a> </button><hr>
