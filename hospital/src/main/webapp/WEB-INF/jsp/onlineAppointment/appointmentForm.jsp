...
<div class="login-clean" style="margin-top: 0px;background-color: rgb(255,255,255);">
    <form action="/onlineappointment/onlineSave" class="shadow-lg" method="post">
        ...
        <div class="form-group"><button class="btn btn-primary btn-block" type="submit" id="sub">Submit</button></div>
