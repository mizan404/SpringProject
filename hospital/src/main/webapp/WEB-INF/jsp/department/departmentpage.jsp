            ...
            <div class="container-fluid">
                <div class="container my-4">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-warning mb-0">Department</h3>
                            ...
                            <section>
                                <ul class="nav nav-pills" id="myTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="home-tab" data-toggle="tab" href="#insert" role="tab" aria-controls="home" aria-selected="false">Insert Department Data</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#update" role="tab" aria-controls="profile" aria-selected="false">Update Department Data</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#view" role="tab" aria-controls="profile" aria-selected="false">View Department Data</a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#delete" role="tab" aria-controls="profile" aria-selected="false">Delete Department Data</a>
                                    </li>
                                </ul>
                                        ...
                                        <section>
                                            <div class="container-fluid">
                                                <div class="container mt-5">
                                                    <div><h4 class="p-0 m-0 pb-3 d-flex justify-content-center">Insert Department Details</h4></div>
                                                    <form action="/department/save" method="post">
                                                        <div class="form-row p-0 m-0">
                                                            <div class="col-lg-6 col-xl-6 p-0 m-0 p-3">
                                                                ...
                                                                <div class="form-group"><input class="form-control" type="text" placeholder="Department Name" name="department_name"/></div>
                                                                <!--<div class="form-group"><input class="form-control" type="text" placeholder="Department Group" name="generic_group"/></div>-->
