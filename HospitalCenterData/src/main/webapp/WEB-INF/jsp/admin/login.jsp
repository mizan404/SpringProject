...
<div class="container" style="margin-top: 100px;">
    <div class="row">
        <div class="col">
            <p class="text-center" style="font-size: 16px; "><strong>Admin Login Page</strong></p>
        </div>
    </div>
    <div class="row">
        <div class="col">
            <p class="text-center" style="font-size: 21px;color: red"><strong>${map.status}</strong></p>
        </div>
    </div>
</div>
